...
1. While Semrush is a great company, there surely is some probability of failure with any company. **We assume a 10% change of probability of failure for Semrush**. 10% is a low number, however, Semrush has been around for more than 15 years and has been tremendously successful. The probability of failure is set in the situation where the co-founders Oleg Shchegolev and Dmitry Melnikov leave the company unexpectedly. These folks practically built the company and thus have very high Key Person value at Semrush. Read [this article](https://aswathdamodaran.blogspot.com/2023/12/the-difference-makers-key-persons.html) to learn more about Key Person Value
