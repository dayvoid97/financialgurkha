...
As much as we'd like to see Semrush's revenue breakdown by each and every country they operate in, which is a lot (_157 countries_) by country and as many segmants as possible, Semrush does not provide much details into where their revenue comes from. The prospectus, however, does break down revenue the following way:
