...
The first step is to join the [Warpcast protocol](https://warpcast.com/~/invite-page/349481?id=e4ec8dd2). \$DEGEN **Airdrop 2** is running until the end of March. Users who post engaging, insightful, creative content have been earnings DEGEN tip allowances. Users active in communities like _[paidgroup](https://warpcast.com/~/channel/replyguys), replyguys, bros_ have also seen incoming degen tip points. A degen tip looks something like this:
